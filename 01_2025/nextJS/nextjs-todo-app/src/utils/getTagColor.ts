export function getTagColor(tag: string): string {
    const map: Record<string, string> = {
      ...
      personal: 'bg-purple-100 text-purple-700 dark:bg-purple-800 dark:text-purple-100',
      work: 'bg-blue-100 text-blue-700 dark:bg-blue-800 dark:text-blue-100',
    };
  
    return map[tag.toLowerCase()] || 'bg-gray-200 text-gray-800 dark:bg-rose-950 dark:bg-sky-500/100';
  }